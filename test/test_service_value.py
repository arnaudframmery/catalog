...
def test_value_update(ctrl_base_2):
    ...
    ctrl_base_2.update_values([{'value': 'value_1_updated', 'value_id': 1, 'code': VALUE_TYPE_CODE.TEXT}])
    assert ctrl_base_2.get_article_detail(article_id=1, catalog_id=1) == [
        {
            'component_id': 1,
            'label': 'component_1',
    ...
    ctrl_base_2.update_values([
        {'value': 'value_2_updated', 'value_id': 2, 'code': VALUE_TYPE_CODE.TEXT},
        {'value': 'value_3_updated', 'value_id': 3, 'code': VALUE_TYPE_CODE.TEXT},
    ])
    assert ctrl_base_2.get_article_detail(article_id=1, catalog_id=1) == [
        {
            'component_id': 1,
