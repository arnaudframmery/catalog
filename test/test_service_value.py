...
def test_value_create(ctrl_base_2):
    ...
    assert ctrl_base_2.get_article_detail(article_id=2, catalog_id=2) == [
        ...
        {'component_id': 3, 'label': 'component_2', 'value': 'default_value_2', 'value_id': None, 'code': 'text'},
    ], 'failed'
    ...
    assert ctrl_base_2.get_article_detail(article_id=2, catalog_id=2) == [
        {'component_id': 2, 'label': 'component_1', 'value': 'value_2', 'value_id': 2, 'code': 'text'},
...
def test_value_update(ctrl_base_2):
    ...
    assert ctrl_base_2.get_article_detail(article_id=2, catalog_id=2) == [
        {'component_id': 2, 'label': 'component_1', 'value': 'value_2_updated', 'value_id': 2, 'code': 'text'},
        {'component_id': 3, 'label': 'component_2', 'value': 'value_3_updated', 'value_id': 3, 'code': 'text'},
    ], 'failed'
    assert ctrl_base_2.get_values(component_id=1) == [{'value': 'value_1_updated', 'id': 1}], 'failed'
