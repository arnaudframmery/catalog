...
def test_article_create(ctrl_base_1):
    assert ctrl_base_1.get_articles(1, [], None, 'ASC') == [], 'failed'
    assert ctrl_base_1.get_articles(2, [], None, 'ASC') == [], 'failed'
    ...
    assert ctrl_base_1.get_articles(1, [], None, 'ASC') == [
        {'title': 'title_1', 'id': 1}, {'title': 'title_2', 'id': 2}
    ], 'failed'
    assert ctrl_base_1.get_articles(2, [], None, 'ASC') == [{'title': 'title_3', 'id': 3}], 'failed'
...
def test_article_delete(ctrl_base_1):
    ...
    assert ctrl_base_1.get_articles(1, [], None, 'ASC') == [{'title': 'title_1', 'id': 1}], 'failed'
